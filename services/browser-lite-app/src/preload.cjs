...
contextBridge.exposeInMainWorld("browserLite", Object.freeze({
  ...
  showSpaces: (options) => ipcRenderer.invoke("browser-lite:show-spaces", options),
  ...
  commitTaskSpaceOpen: (id) => ipcRenderer.invoke("browser-lite:commit-task-space-open", id),
