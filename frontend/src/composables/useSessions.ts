...
interface SiteInfo {
  ...
  features: { sso: boolean; multiTenantManagement: boolean; browserImages?: boolean; fileStorage?: boolean; runtimeShellTools?: boolean; remoteClipboard?: boolean; managedRuntime?: boolean }
...
const brand = reactive<BrandConfig>({
  ...
  edition: 'ce',
  setupComplete: false,
  features: { sso: false, multiTenantManagement: false, browserImages: true, fileStorage: true, runtimeShellTools: true, remoteClipboard: true, managedRuntime: false },
