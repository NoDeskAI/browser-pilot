...
<template>
  <header class="shrink-0 h-14 border-b border-border bg-background flex items-center justify-between px-4 z-20">
    ...
    <div class="flex items-center gap-2">
      <nav class="flex items-center gap-1 mr-4">
        <button
          ...
          class="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
        >
      ...
      <DropdownMenu>
        <DropdownMenuTrigger as-child>
          <button class="flex items-center gap-2 px-2 py-1.5 rounded-md text-sm text-muted-foreground hover:bg-muted/50 hover:text-foreground transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring">
            <span class="truncate text-xs max-w-[120px]">{{ user?.email }}</span>
